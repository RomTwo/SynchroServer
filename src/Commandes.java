...
public enum Commandes {
    ...
    RECV("recv"),/**< Enumération RECV avec comme valeur "recv" */
    SCAN("scan"),/**< Enumération SCAN avec comme valeur "scan" */
    STOPSCAN("stopscan"),/**< Enumération STOPSCAN avec comme valeur "stopscan" */
